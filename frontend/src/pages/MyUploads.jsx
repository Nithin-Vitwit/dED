...
const MyUploads = () => {
    ...
    const fetchMyCourses = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/api/courses/my-courses?creator=${publicKey.toString()}`);
            ...
            <div className="container-fluid py-4">
                ...
                {loading ? (
                    <div style={{ textAlign: 'center', padding: '4rem' }}>
                        <div className="mono-text">Loading your courses...</div>
                    </div>
                ) : myCourses.length > 0 ? (
