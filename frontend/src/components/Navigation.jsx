        ...
        <nav className="navbar">
            <div className="container-fluid" style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    ...
                    {/* Marketplace */}
                    <Link to="/marketplace" className="icon-btn" title="Marketplace">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    {/* Upload */}
                    <Link to="/upload" className="icon-btn" title="Upload Course">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    {/* My Uploads */}
                    <Link to="/my-uploads" className="icon-btn" title="My Uploads">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <Link to="/my-purchases" className="icon-btn" title="My Purchases">
                        <svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
